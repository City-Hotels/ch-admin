...
import { ILoginResponse } from "@/services/auth/response";
...
const SignIn: React.FC = () => {
  ...
  // const isFetchingUser = useAppSelector(isLoading);
  ...
  const loginCallback = async (resp: ApiResponse<ILoginResponse>) => {
    if (resp.success) {
  ...
  const googleLoginCallback = (credentials: CredentialResponse) => {
    setGoogleLoading(true);
    googleLogin({ Token: credentials.credential || "" })
      .then(loginCallback)
      .catch(loginCallback)
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex flex-wrap items-center h-[100vh]">
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="px-26 py-17.5 text-center">
            <Link
              href="/"
              className="flex items-center justify-center gap-2 mb-5.5"
            >
              <Img path={Logo} name="Logo" className="w-10 h-10" />

              <h1 className="text-black dark:text-white100 text-[32px] font-cal font-medium">
                Admin
              </h1>
            </Link>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="text-left">
                      <Label>Email</Label>
                      <Input label="" name="LoginId" />
                    </div>
                    <div className="mb-4 text-left">
                      <Label>Password</Label>
                      <Input type="password" label="" name="Password" />
                    </div>
                  </div>
