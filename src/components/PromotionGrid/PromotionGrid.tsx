import { PromotionStatus, AccountType, PricingType } from '@/services/promotions/payload'
    ...
    <div>
        ...
        <div className="md:w[33%] px-2 flex flex-col gap-3">
          <div>
            ...
            <P2 className={`${styles.promotionValue}`}>{promotion?.Name}</P2>
          </div>

          <div>
            <Label className={`${styles.promotionLabel}`}>Id</Label>
            <P2 className={`${styles.promotionValue}`}>#{promotion?.Id}</P2>
          </div>

          <div>
            <Label className={`${styles.promotionLabel}`}>Title</Label>
            <P2 className={`${styles.promotionValue}`}>{promotion?.Title}</P2>
          </div>

          <div>
            <Label className={`${styles.promotionLabel}`}>Description</Label>
            <P2 className={`${styles.promotionValue}`}>{promotion?.Description}</P2>
          </div>

          <div>
            <Label className={`${styles.promotionLabel}`}>Created At</Label>
          ...
          <div>
            <Label className={`${styles.promotionLabel}`}>Last Updated</Label>
            <P2 className={`${styles.promotionValue}`}>
          ...
          <div>
            <Label className={`${styles.promotionLabel}`}>Max Participants</Label>
            <P2 className={`${styles.promotionValue}`}>
          ...
          <div>
            <Label className={`${styles.promotionLabel}`}>Promotion Status</Label>
            <P2 className={`${styles.promotionValue}`}>
        ...
        <div className="md:w[33%]  mt-7 md:mt-0 md:border-solid md:border-x md:border-x-neutral-40 px-2">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div>
              <Label className={`${styles.promotionLabel}`}>Maximum Bookings</Label>
              <P2 className={`${styles.promotionValue}`}>
            ...
            <div>
              <Label className={`${styles.promotionLabel}`}>Minimum Bookings</Label>
              <P2 className={`${styles.promotionValue}`}>
                {promotion?.Requirement?.MaximumBooking
                  ? `${promotion?.Requirement?.MaximumBooking}`
                  : "0"}
            ...
            <div>
              <Label className={`${styles.promotionLabel}`}>Account Type</Label>
              <P2 className={`${styles.promotionValue}`}>
        ...
        <div className="md:w[33%] mt-7 md:mt-0 px-2">
          ...
          <div className="flex flex-col gap-3">
            <div>
              <Label className={`${styles.promotionLabel}`}>Booking Discount</Label>
              <P2 className={`${styles.promotionValue}`}>
